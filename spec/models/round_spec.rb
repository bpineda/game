...
RSpec.describe Round, type: :model do
  ...
  it "has a winner with the highest number after the pair is tied" do
    ...
    hand_high = Hand.new
    hand_high.round = round
    hand_high.cards << Card.new(suit: "spades", value: 8, numeric_value: 4)
    hand_high.cards << Card.new(suit: "clubs", value: 7, numeric_value: 4)
    hand_high.cards << Card.new(suit: "diams", value: 6, numeric_value: 8)
    hand_high.cards << Card.new(suit: "hearts", value: 5, numeric_value: 2)
    hand_high.cards << Card.new(suit: "hearts", value: 2, numeric_value: 2)
    ...
    second_hand_high.cards << Card.new(suit: "spades", value: 8, numeric_value: 4)
    second_hand_high.cards << Card.new(suit: "clubs", value: 7, numeric_value: 4)
    second_hand_high.cards << Card.new(suit: "diams", value: 6, numeric_value: 7)
    second_hand_high.cards << Card.new(suit: "hearts", value: 5, numeric_value: 3)
    second_hand_high.cards << Card.new(suit: "hearts", value: 3, numeric_value: 3)
